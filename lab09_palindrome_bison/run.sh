#!/usr/bin/env bash
# ============================================================
# run.sh -- Lab 09 Bison Palindrome Checker
# ============================================================
# Interactive: type a word or phrase line by line. Each ENTER
# tells you whether the line is a palindrome. Press ENTER on
...
echo -e "${CYAN}[INFO]${NC} Starting interactive palindrome checker ..."
echo "----------------------------------------"
./"$PROGRAM"
echo "----------------------------------------"
